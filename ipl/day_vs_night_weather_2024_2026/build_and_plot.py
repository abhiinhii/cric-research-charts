"""
IPL 2024-2026: Day vs Night weather analysis.
...
def load() -> pd.DataFrame:
    ...
    WITH ipl AS (
        ...
        WHERE m.event_name LIKE '%Indian Premier League%'
          AND m.season IN ('2024','2025','2026')
    ),
    classified AS (
        SELECT
            i.match_id, i.season, i.start_date, i.venue, i.city,
            CASE
                WHEN i.season = '2024' THEN
                    CASE
...
def main():
    ...
    plans = [
        ("temp_c", "Match-window mean temperature (°C)",
         "IPL 2024–2026: 1st innings RR vs Temperature (Day vs Night)", "ipl_temp_dn.png"),
        ("humidity_pct", "Match-window mean relative humidity (%)",
         "IPL 2024–2026: 1st innings RR vs Humidity (Day vs Night)", "ipl_humidity_dn.png"),
        ("rain_ema_7d", "7-day rainfall EMA (mm/day, prior day)",
         "IPL 2024–2026: 1st innings RR vs 7-day Rainfall EMA (Day vs Night)", "ipl_rain7d_dn.png"),
        ("rain_ema_30d", "30-day rainfall EMA (mm/day, prior day)",
         "IPL 2024–2026: 1st innings RR vs 30-day Rainfall EMA (Day vs Night)", "ipl_rain30d_dn.png"),
    ]
    full_summary: dict = {}
